...
import {CommentsRes, PostRes} from '../../../data/interfces/post.interface.ts';
import {  PostsFromUsersInterface, PostsStateInterface } from './postState.interface';
...
const adapter: EntityAdapter<PostsStateInterface|null> = createEntityAdapter<PostsStateInterface|null>()

const PostsFromUsersInitialState: PostsFromUsersInterface = adapter.getInitialState({backendErrors:null})
